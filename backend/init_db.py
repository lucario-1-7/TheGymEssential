...
def seed_db():
    ...
    exercise_data = [
        {"name": "Barbell bench press",    "movement_pattern": "push",  "equipment": "barbell",    "is_unilateral": False, "primary": ["chest"],      "secondary": ["triceps", "shoulders"]},
        {"name": "Incline dumbbell press", "movement_pattern": "push",  "equipment": "dumbbell",   "is_unilateral": False, "primary": ["chest"],      "secondary": ["triceps", "shoulders"]},
        ...
        {"name": "Romanian deadlift",      "movement_pattern": "hinge", "equipment": "barbell",    "is_unilateral": False, "primary": ["hamstrings"], "secondary": ["glutes", "back"]},
        {"name": "Pull up",                "movement_pattern": "pull",  "equipment": "bodyweight",  "is_unilateral": False, "primary": ["back"],       "secondary": ["biceps"]},
        {"name": "Barbell row",            "movement_pattern": "pull",  "equipment": "barbell",    "is_unilateral": False, "primary": ["back"],       "secondary": ["biceps"]},
        {"name": "Overhead press",         "movement_pattern": "push",  "equipment": "barbell",    "is_unilateral": False, "primary": ["shoulders"],  "secondary": ["triceps"]},
        {"name": "Dumbbell lateral raise", "movement_pattern": "push",  "equipment": "dumbbell",   "is_unilateral": False, "primary": ["shoulders"],  "secondary": []},
